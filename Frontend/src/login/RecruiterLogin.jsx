...
const RecruiterLogin = () => {
    ...
    const submitHandler = async (e) => {
      ...
      try{
        ...
        const response = await axios.get(`http://localhost:8080/api/recruiters/login?email=${login.email}&password=${login.password}`)
      ...
      <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md border border-gray-100">
        ...
        {formType === 'login' && (
          <form onSubmit={(e) => submitHandler(e)}>
            <h1 className="text-3xl font-bold mb-8 text-center text-gray-900">Recruiter Login</h1>
            <div className="mb-6">
